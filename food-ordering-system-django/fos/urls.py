...
urlpatterns = [
    ...
    url(r'^customers/view-menu-by-id/(?P<id>[\w+]+)$', views.ViewMenuById.as_view(), name='menu-by-id'),  # do
    url(r'^employees/delivery-person-location/$', views.DeliverPersonLocation.as_view(), name='DeliverPersonLocation'),  # do
]